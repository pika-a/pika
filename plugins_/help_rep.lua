...
if not PIKABOT:get(PIKA_ID..'lock:reoly:bot'..msg.chat_id_) then
...
PIKA_sendMsg(msg.chat_id_, msg.id_, 1,taha8[math.random(#taha8)], 1, 'html') 
end
...
PIKA_sendMsg(msg.chat_id_, msg.id_, 1,taha9[math.random(#taha9)], 1, 'html') 
end
...
PIKA_sendMsg(msg.chat_id_, msg.id_, 1,taha10[math.random(#taha10)], 1, 'html') 
end
...
PIKA_sendMsg(msg.chat_id_, msg.id_, 1, ''..taha[math.random(#taha)]..'', 1, 'md')
end 
...
'هـايـات يـروحـي┋🌸', 
'يههلا بيك حياتي 💛🌿'}      PIKA_sendMsg(msg.chat_id_, msg.id_, 1, ''..taha[math.random(#taha)]..'', 1, 'md')   
end
...
'ﯛ୭ﯠ۶ـہٰٰٰٖٖٖلہٰٰٰٖٖٖيکگہٰٰٰٖٖٖمہٰٰٰٖٖٖہ ٵٴلہٰٰٰٖٖٖسہلہٰٰٰٖٖٖاٴمہٰٰٰٖٖٖہ ┆ ➰✌️🏿'}  PIKA_sendMsg(msg.chat_id_, msg.id_, 1, ''..taha[math.random(#taha)]..'', 1, 'md') 
end 
...
if text =="🌚" then 
taha =   "• فـﮧديت صخـﮧامك🙊👄" 
PIKA_sendMsg(msg.chat_id_, msg.id_, 1, taha, 1, "html") 
end
if text == "🌚🌚" then 
taha =   "• فـﮧديت صخـﮧامك🙊👄" 
PIKA_sendMsg(msg.chat_id_, msg.id_, 1, taha, 1, "html") 
...
if text =="تعالو" then 
taha =   " ما اروح الموبرمجين مالتي ميقبلون " 
PIKA_sendMsg(msg.chat_id_, msg.id_, 1, taha, 1, "html") 
end
if text =="تعالوو" then 
taha =   "لا ما اروح الموبرمجين مالتي ميقبلون🎈" 
PIKA_sendMsg(msg.chat_id_, msg.id_, 1, taha, 1, "html") 
end
...
if text =="شبيكم" then 
taha =   "مبينه شي سلامتك/ ج🎈😌"   PIKA_sendMsg(msg.chat_id_, msg.id_, 1, taha, 1, "html") 
end
if text =="شبيكك" then 
taha =   "مبينه شي سلامتك/ ج🎈😌" 
PIKA_sendMsg(msg.chat_id_, msg.id_, 1, taha, 1, "html") 
...
if text =="ماريا" then 
taha =   "ولك هاي الصاكه العشق هاي حبيبت الموبرمج هاي 😸🙊😻😻️" 
PIKA_sendMsg(msg.chat_id_, msg.id_, 1, taha, 1, "html") 
end
if text =="😂😂😂😂😂😂" then 
taha =   "يضحك الفطير 😹😹" 
...
if PIKABOT:get(PIKA_ID..'lock:reoly:bot'..msg.chat_id_) then
taha = '*📮¦ تم تفعيل ردود البوت *\n✓' 
PIKA_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
PIKABOT:del(PIKA_ID..'lock:reoly:bot'..msg.chat_id_) 
else
...
PIKA_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
PIKABOT:set(PIKA_ID..'lock:reoly:bot'..msg.chat_id_,true) 
else
...
PIKA_sendMsg(msg.chat_id_, msg.id_, 1,delac, 1, 'md')
 end

if MSG_TEXT[1] == 'الاوامر' then
if not is_mod(msg) then 
PIKA_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ انت لست ضمن الادمنيه 🍃\n📌¦ يمكنك ارسال { م2 } لعرض قائمة اوامر خاصه في الاعضاء *\n💥", 1, "md")  
return false end
taha = [[
⚠️
...
⚙¦ م7 = لعَرض اوامر اﻟ̣موبرمج
🏮¦ م8 = لعَرض اوامر اﻟ̣موبرمج الاساسي 
 ----------------------------------------------
...
PIKA_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ انت لست ضمن المدراء 🍃\n📌¦ يمكنك ارسال { م2 } لعرض قائمة اوامر خاصه في الاعضاء *\n💥", 1, "md")  
return false end
taha = [[
*🙋🏻‍♂¦ مرحبا بك عزيزي، 🍃
📮¦ في اوامــر المدراء 
...
PIKA_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ انت لست ضمن المنشئين 🍃\n📌¦ يمكنك ارسال { م2 } لعرض قائمة اوامر خاصه في الاعضاء *\n💥", 1, "md")  
return false end
taha = [[
*🙋🏻‍♂¦ مرحبا بك عزيزي، 🍃
📮¦ في اوامــر المنڜئين'
...
PIKA_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ انت لست ضمن الموبرمجين 🍃\n📌¦ يمكنك ارسال { م2 } لعرض قائمة اوامر خاصه في الاعضاء *\n💥", 1, "md")  
return false end
taha = [[
*🙋🏻‍♂¦ مرحبا بك عزيزي، 🍃
📮¦ في اوامــر الموبرمجيَن .
ٴ━━━━━━━━━━
🏵¦ تفعيل – تعطيل ! 
🏵¦ الكروبات – المڜتركين !
🏵¦ رفع منشئ – تنزيل منشئ !
...
PIKA_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ انت لست الموبرمج الاساسي 🍃\n📌¦ يمكنك ارسال { م2 } لعرض قائمة اوامر خاصه في الاعضاء *\n💥", 1, "md")  
return false end
taha = [[
*🙋🏻‍♂¦ مرحبا بك عزيزي، 🍃
📮¦ في اوامــر الموبرمج الآسٰاسي .
ٴ━━━━━━━━━━
⚜¦ ارسل الاوامَر فيہَ الخاص
⚜¦ حظر + ايدي الكروب
⚜¦ الغاء الحظر + ايدي الكروب
ٴ━━━━━━━━━━
📨¦ رفع موبرمج – تنزيل موبرمج   
📨¦ المطَورين – مسح الموبرمجين
📨¦ رفع مميز عامہ – تنزيل مميز عامہ
📨¦ المميزين عامہ – مسح المميزين عام
📨¦ حظر عامہ – الغاء العامہ 
📨¦ قائمهہَ العامہ – مسح قائمه العام
ٴ━━━━━━━━━━
📌¦ ردود الموبرمج - مسح ردود الموبرمج
📌¦ تفعيل ردود الموبرمج
📌¦ تعطيل ردود الموبرمج 
📌¦ اضف رد عام - مسح رد عام 
📌¦ ردود الموبرمج بالرد 
📌¦ مسح ردود الموبرمج بالرد
📌¦ تفعيل ردود الموبرمج بالرد
📌¦ تعطيل ردود الموبرمج بالرد
📌¦ اضف رد عام بالرد 
📌¦ حذف رد عام بالرد 
ٴ━━━━━━━━━━
📯¦ وضع اسم للبوت 
