...
io.write('\27[1;31m ↡ ارسل ايدي موبرمج الاساسي |\n SEND ID FOR SIDO : \27[0;39;49m')
local SUDOID = io.read()
if SUDOID ~= '' then
io.write('\n\27[1;34m تم حفظ ايدي الموبرمج |\n\27[0;39;49m')
PIKABOT:set(DEVPIKA..":SUDO:ID",SUDOID)
else
print('\n\27[1;34m لم يتم حفظ ايدي الموبرمج |')
end 
os.execute('lua PIKA.lua')
end
if not PIKABOT:get(DEVPIKA..":SUDO:USERNAME") then
io.write('\27[1;31m ↡ ارسل معرف الموبرمج الاساسي |\n SEND ID FOR SIDO : \27[0;39;49m')
local SUDOUSERNAME = io.read():gsub('@','')
if SUDOUSERNAME ~= '' then
io.write('\n\27[1;34m تم حفظ معرف الموبرمج |\n\27[0;39;49m')
PIKABOT:set(DEVPIKA..":SUDO:USERNAME",'@'..SUDOUSERNAME)
else
print('\n\27[1;34m لم يتم حفظ معرف الموبرمج |')
end 
os.execute('lua PIKA.lua')
end
...
local text = '📮¦ اهلا بك عزيزي الموبرمج الاساسي '..
...
if text == '/start' then  
if is_devtaha(msg) then
local taha = '*📮¦ اهلا بك عزيزي الموبرمج 🍃'..
...
{'مسح قائمه العام 🚷','مسح المميزين عام 🌟','مسح الموبرمجين 👮'},
{'ضع رد تواصل 💻','ضع كليشه الموبرمج 🎐','ضع كليشه ستارت 📠'},
{'تعطيل رساله الترحيب 📱','تفعيل رساله الترحيب 🎌','ضع عدد الاعضاء 📜'},
{"حذف كليشه الموبرمج 🀄","حذف كليشه ستارت 🃏","حذف رد التواصل 📌"},
{"جلب رد التواصل 📚","جلب كليشه ستارت 📚"},
{'الموبرمجين 📑','المحظورين عام 📑','المميزين عام 📑'},
{'الغاء ✖'}}
...
PIKA_sendMsg(msg.sender_user_id_, msg.id_, 1, '📬*¦* تم ارسال رسالتك الى الموبرمج\n*📛¦* اشترك في قناة الموبرمج \n*🚸¦* [اضغط هنا للدخول الى قناة](https://t.me/joinchat/AAAAAElyffap0iuWjaf9eQ) \n', 1, "md")    
end     
...
if text == 'مسح الموبرمجين 👮' and is_devtaha(msg) then     local list = PIKABOT:smembers(PIKA_ID..'sudo:bot')    if #list == 0 then  PIKA_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦* لا يوجد موبرمجين ليتم مسحهم\n', 1, 'md')   return false  end  local num = 0  for k,v in pairs(list) do    PIKABOT:srem(PIKA_ID.."sudo:bot",v)    num = num + 1  end   PIKA_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ تم مسح {'..num..'} من الموبرمجين *\n', 1, 'md')   end
...
if text and text:match("^ضع كليشه الموبرمج 🎐$") and is_devtaha(msg) then PIKABOT:setex(PIKA_ID.."sudo:dev" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  PIKA_sendMsg(msg.chat_id_, msg.id_, 1,'📬*¦* ارسل لي النص الذي تريده ', 1, 'md') end 
...
if text == "حذف كليشه الموبرمج 🀄" and is_devtaha(msg) then  PIKABOT:del(PIKA_ID.."dev") PIKA_sendMsg( msg.chat_id_, msg.id_, 1, '*📛¦*تم حذف كليشه الموبرمج', 1, "md") end 
...
os.execute('cd plugins_;wget https://raw.githubusercontent.com/pika-a/pikamaster/plugins_/games.lua') 
sleep(0.5) 
...
if text == 'الموبرمجين 📑' and is_devtaha(msg) then   local list = PIKABOT:smembers(PIKA_ID..'sudo:bot')  local t = '*📮¦ قائمه موبرمجين البوت *\n*ٴ━━━━━━━━━*\n'   for k, v in pairs(list) do   local taha = PIKABOT:get(PIKA_ID.."user:Name" .. v)  if taha then  local username = taha  t = t..'*'..k.." ➺* ❲["..username.."](tg://user?id="..v..")❳\n"     else  t = t..'*'..k.." ➺* ❲["..v.."](tg://user?id="..v..")❳\n"     end  end   if #list == 0 then   t = '*📬¦* لا يوجد موبرمجين في البوت'   end   PIKA_sendMssg(msg.chat_id_,t,msg.id_,'md')  end  
...
--======================
--ردود الموبرمج بالرد
if text == 'تفعيل ردود الموبرمج بالرد' and is_devtaha(msg) then   
if PIKABOT:get(PIKA_ID..'lock:rep:all:rd'..bot_id) then
taha = '*📮¦ تم تفعيل ردود الموبرمج بالرد *\n✓' 
PIKA_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
...
if text == 'تعطيل ردود الموبرمج بالرد' and is_devtaha(msg) then  
if not PIKABOT:get(PIKA_ID..'lock:rep:all:rd'..bot_id) then
taha = '*📮¦ تم تعطيل ردود الموبرمج بالرد *\n✓' 
PIKA_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
...
if text == "مسح ردود الموبرمج بالرد" and is_devtaha(msg) then    
...
if  text == "ردود الموبرمج بالرد" and is_devtaha(msg) then    
local list = PIKABOT:smembers(PIKA_ID.."rep:media:all:rd"..bot_id)    
t = "*📮¦ قائمة ردود الموبرمج بالرد 🍃\nٴ━━━━━━━━━━━*\n"    
for k,v in pairs(list) do    
...
--======================
--ردود الموبرمج
if text == 'تفعيل ردود الموبرمج' and is_devtaha(msg) then   
if PIKABOT:get(PIKA_ID..'lock:rep:all'..bot_id) then
taha = '*📮¦ تم تفعيل ردود الموبرمج *\n✓' 
PIKA_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
...
if text == 'تعطيل ردود الموبرمج' and is_devtaha(msg) then  
if not PIKABOT:get(PIKA_ID..'lock:rep:all'..bot_id) then
taha = '*📮¦ تم تعطيل ردود الموبرمج *\n✓' 
PIKA_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
...
if text == "مسح ردود الموبرمج" and is_devtaha(msg) then    
...
if  text == "ردود الموبرمج" and is_devtaha(msg) then    
local list = PIKABOT:smembers(PIKA_ID.."rep:media:all"..bot_id)    
t = "*📮¦ قائمة ردود الموبرمج 🍃\nٴ━━━━━━━━━━━*\n"    
for k,v in pairs(list) do    
...
PIKA_sendMsg(msg.chat_id_, msg.id_, 1, ' انجب لك شون اهين موبرمجي \n ', 1, 'md')  
return false  end  
local taha = { 
...
PIKA_sendMsg(msg.chat_id_, msg.id_, 1, 'شو انته كاعد تمضرط غير هاذا الموبرمج مالتي 😌\n ', 1, 'md')  
return false  end 
local taha = { 
...
if text == 'مسح الموبرمجين' and is_devtaha(msg) then   
local list = PIKABOT:smembers(PIKA_ID..'sudo:bot')  
if #list == 0 then
PIKA_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦* لا يوجد موبرمجين ليتم مسحهم\n', 1, 'md') 
return false  end
local num = 0
for k,v in pairs(list) do  
...
PIKA_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ تم مسح {'..num..'} من الموبرمجين *\n', 1, 'md') 
end
...
if text ==('رفع موبرمج') and is_devtaha(msg) then 
function prom_reply(extra, result, success) 
tdcli_function ({
ID = "GetUser",
user_id_ = result.sender_user_id_
...
if text and text:match('^رفع موبرمج @(.*)') and is_devtaha(msg) then 
local username = text:match('^رفع موبرمج @(.*)') 
function promreply(extra,result,success) 
if result and result.message_ and result.message_ == "USERNAME_NOT_OCCUPIED" then 
local taha = '*📮¦ المعرف لا يوجد فيه حساب *'
PIKA_sendMsg(msg.chat_id_, msg.id_, 1,taha, 1, 'md')
...
if text and text:match('^رفع موبرمج (%d+)') and is_devtaha(msg) then 
local user = text:match('رفع موبرمج (%d+)')
tdcli_function ({
ID = "GetUser",
user_id_ = user
},function(arg,data) 
...
if text ==('تنزيل موبرمج') and is_devtaha(msg) then 
function prom_reply(extra, result, success) 
tdcli_function ({
ID = "GetUser",
user_id_ = result.sender_user_id_
...
if text and text:match('^تنزيل موبرمج @(.*)') and is_devtaha(msg) then 
local username = text:match('^تنزيل موبرمج @(.*)') 
function promreply(extra,result,success) 
if result and result.message_ and result.message_ == "USERNAME_NOT_OCCUPIED" then 
local taha = '*📮¦ المعرف لا يوجد فيه حساب *'
PIKA_sendMsg(msg.chat_id_, msg.id_, 1,taha, 1, 'md')
...
if text and text:match('^تنزيل موبرمج (%d+)') and is_devtaha(msg) then 
local user = text:match('تنزيل موبرمج (%d+)')
tdcli_function ({
ID = "GetUser",
user_id_ = user
},function(arg,data) 
...
if text == 'الموبرمجين' and is_devtaha(msg) then 
local list = PIKABOT:smembers(PIKA_ID..'sudo:bot')
local t = '*📮¦ قائمه موبرمجين البوت *\n*ٴ━━━━━━━━━*\n' 
for k, v in pairs(list) do 
local taha = PIKABOT:get(PIKA_ID.."user:Name" .. v)
if taha then
local username = taha
...
if text == "موبرمجين البوت" or text == "اريد بوت" or text == "الموبرمج" or text == "موبرمج" then  
local dev = PIKABOT:get(PIKA_ID.."dev") 
if dev then 
PIKA_sendMsg(msg.chat_id_, msg.id_,1,''..check_markdown(dev)..'',1,'md') 
else 
PIKA_sendMsg(msg.chat_id_, msg.id_,1,'💢*¦* عذرا لم يتم وضع كليشه الموبرمج ',1,'md')  
end  
end
if text == "حذف كليشه الموبرمج" and is_devtaha(msg) then  
PIKABOT:del(PIKA_ID.."dev") 
PIKA_sendMsg( msg.chat_id_, msg.id_, 1, '*📛¦*تم حذف كليشه الموبرمج', 1, "md") 
end 
...
PIKA_send(msg.chat_id_,msg.id_,"*📮¦ عذرا لا تستطيع منع » { المنشئين والموبرمجين } \n👨🏻‍✈️*")   
return false  
end    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = result.sender_user_id_},function(arg,da) 
